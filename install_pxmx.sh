...
ExecStart=/usr/bin/env PYTHONPATH=$INSTALL_DIR/lm/core/src $INSTALL_DIR/pxmx/venv/bin/python3 -m src.control_plane --id $SPOKE_ID --secret $SPOKE_SECRET --hub $HUB_URL
Restart=on-failure
RestartSec=10
