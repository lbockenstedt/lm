...
if __name__ == "__main__":
    ...
    SPOKE_ID = os.getenv("LM_GHOST_TENANT_ID", "spoke-1")
    SECRET = os.getenv("LM_GHOST_TENANT_SECRET")
    if not SECRET:
        print("Set LM_GHOST_TENANT_SECRET to a real first-secret from the Hub to run the ghost tenant suite.")
        raise SystemExit(1)
