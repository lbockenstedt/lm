...
echo "🚀 Installing Unbound DNS Spoke..."

# 1. Install System Dependencies
apt-get update
apt-get install -y unbound python3-pip python3-venv
...
cat <<EOF > /etc/systemd/system/lm-unbound.service
[Unit]
Description=Lab Manager Unbound DNS Spoke
...
systemctl enable lm-unbound
systemctl restart lm-unbound

echo "🎉 Unbound DNS Spoke installation complete!"
