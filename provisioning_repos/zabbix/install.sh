...
echo "🚀 Installing Zabbix Spoke..."

# 1. Install System Dependencies
apt-get update
apt-get install -y zabbix-agent python3-pip python3-venv
...
cat <<EOF > /etc/systemd/system/lm-zabbix.service
[Unit]
Description=Lab Manager Zabbix Spoke
...
systemctl enable lm-zabbix
systemctl restart lm-zabbix

echo "🎉 Zabbix Spoke installation complete!"
