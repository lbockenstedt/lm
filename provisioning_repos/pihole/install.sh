...
echo "🚀 Installing Pi-hole Spoke..."

# 1. Install System Dependencies
apt-get update
apt-get install -y curl python3-pip python3-venv

# Run Pi-hole basic installer (non-interactive)
...
cat <<EOF > /etc/systemd/system/lm-pihole.service
[Unit]
Description=Lab Manager Pi-hole Spoke
...
systemctl enable lm-pihole
systemctl restart lm-pihole

echo "🎉 Pi-hole Spoke installation complete!"
