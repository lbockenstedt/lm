...
echo "🚀 Installing Netbox Spoke..."

# 1. Install System Dependencies
apt-get update
apt-get install -y python3-pip python3-venv postgresql redis-server
...
cat <<EOF > /etc/systemd/system/lm-netbox.service
[Unit]
Description=Lab Manager Netbox Spoke
...
echo "🎉 Netbox Spoke installation complete!"
