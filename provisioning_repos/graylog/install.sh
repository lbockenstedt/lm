...
echo "🚀 Installing GrayLog Spoke..."

# 1. Install System Dependencies
apt-get update
apt-get install -y openjdk-11-jre-headless python3-pip python3-venv mongodb-org
...
cat <<EOF > /etc/systemd/system/lm-graylog.service
[Unit]
Description=Lab Manager GrayLog Spoke
...
systemctl enable lm-graylog
systemctl restart lm-graylog

echo "🎉 GrayLog Spoke installation complete!"
