...
echo "🚀 Installing iPerf Spoke..."

# 1. Install System Dependencies
apt-get update
apt-get install -y iperf3 python3-pip python3-venv
...
cat <<EOF > /etc/systemd/system/lm-iperf.service
[Unit]
Description=Lab Manager iPerf Spoke
...
systemctl enable lm-iperf
systemctl restart lm-iperf

echo "🎉 iPerf Spoke installation complete!"
