...
echo "🚀 Installing ConsolePi Spoke..."
...
cat <<EOF > /etc/systemd/system/lm-consolepi.service
[Unit]
Description=Lab Manager ConsolePi Spoke
...
systemctl enable lm-consolepi
systemctl restart lm-consolepi

echo "🎉 ConsolePi Spoke installation complete!"
