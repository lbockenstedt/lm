...
cat <<EOF > /etc/systemd/system/lm-bugfix.service
[Unit]
Description=Lab Manager Bugfix Spoke
...
systemctl enable lm-bugfix
systemctl restart lm-bugfix

echo "🎉 Bugfix Spoke installation complete!"
